# 1 "d:\\test_program\\git\\performncelab_hp_loadrunner\\gorkovaa_task1_searchtopic_nbnote\\gorkovaa_task1_searchtopic_nbnote\\\\combined_GorkovAA_Task1_SearchTopic_nbnote.c"
...
# 1 "d:\\test_program\\git\\performncelab_hp_loadrunner\\gorkovaa_task1_searchtopic_nbnote\\gorkovaa_task1_searchtopic_nbnote\\\\combined_GorkovAA_Task1_SearchTopic_nbnote.c" 2
...
# 2 "d:\\test_program\\git\\performncelab_hp_loadrunner\\gorkovaa_task1_searchtopic_nbnote\\gorkovaa_task1_searchtopic_nbnote\\\\combined_GorkovAA_Task1_SearchTopic_nbnote.c" 2
...
# 3 "d:\\test_program\\git\\performncelab_hp_loadrunner\\gorkovaa_task1_searchtopic_nbnote\\gorkovaa_task1_searchtopic_nbnote\\\\combined_GorkovAA_Task1_SearchTopic_nbnote.c" 2
...
# 4 "d:\\test_program\\git\\performncelab_hp_loadrunner\\gorkovaa_task1_searchtopic_nbnote\\gorkovaa_task1_searchtopic_nbnote\\\\combined_GorkovAA_Task1_SearchTopic_nbnote.c" 2
...
{		
	...
	lr_end_transaction("UC01_TR02_Jump_Test_forum",2);

	lr_start_transaction("UC01_TR033_Jump_Search");

	lr_end_transaction("UC01_TR033_Jump_Search",2);
	...
	if (web_reg_find("Text=Posts found:", "Search=Body", "LAST") == 0) {  
		...
		lr_end_transaction("UC01_TR03_Search_Input_Topic",2);
        return(0);
	}	
	...
	if (success_search) {
		...
		for (i = 0; i < 2; i++) {
			...
			lr_end_transaction("UC01_TR04_Jump_Random_Topic",2);
		...
		lr_end_transaction("UC01_TR06_Jump_Random_Topic_3",2);	
		...
		lr_end_transaction("UC01_TR07_Send_Comment_Topic_3",2);	
...
# 5 "d:\\test_program\\git\\performncelab_hp_loadrunner\\gorkovaa_task1_searchtopic_nbnote\\gorkovaa_task1_searchtopic_nbnote\\\\combined_GorkovAA_Task1_SearchTopic_nbnote.c" 2
...
vuser_end()
{
	...
	lr_end_transaction("UC01_TR08_Logout",2);
	
	return 0;
}
# 6 "d:\\test_program\\git\\performncelab_hp_loadrunner\\gorkovaa_task1_searchtopic_nbnote\\gorkovaa_task1_searchtopic_nbnote\\\\combined_GorkovAA_Task1_SearchTopic_nbnote.c" 2
